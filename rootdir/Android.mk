...
include $(CLEAR_VARS)
LOCAL_MODULE		:= bootbridge_init
LOCAL_SRC_FILES		:= bootbridge-init.c
...
include $(CLEAR_VARS)
LOCAL_MODULE       := init.sony-trimarea.rc
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/init.sony-trimarea.rc
LOCAL_MODULE_PATH  := $(TARGET_ROOT_OUT)
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := init.mt6757.platform.rc
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/init.mt6757.platform.rc
LOCAL_MODULE_PATH  := $(TARGET_ROOT_OUT)
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE		:= fstab.mt6757.root
LOCAL_MODULE_STEM	:= fstab.mt6757
LOCAL_MODULE_TAGS	:= optional
LOCAL_MODULE_CLASS	:= ETC
LOCAL_SRC_FILES		:= etc/fstab.mt6757
LOCAL_MODULE_PATH	:= $(TARGET_ROOT_OUT)
...
ifeq ($(BOARD_BOOT_RAMDISK_WITH_SYSTEM_ROOT),true)
include $(CLEAR_VARS)
LOCAL_MODULE := fstab.mt6757.first_stage
LOCAL_MODULE_STEM := fstab.mt6757
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := etc/fstab.mt6757.first_stage
